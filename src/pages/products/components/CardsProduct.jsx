...
class CardsProduct extends Component {
    state={
        listData : [
            {id:'1', order:0, promo: 0, image: 'https://picsum.photos/id/326/200',name:' Manggo Juice', category: 'drink', price: '15000', description: 'dengan menggunakan buah asli'},
            {id:'2', order:0, promo: 10, image: 'https://picsum.photos/id/324/200',name:' Apple Juice', category: 'drink', price: '15000', description: 'dengan menggunakan buah asli'},
            {id:'3', order:0, promo: 0, image: 'https://picsum.photos/id/36/200',name:' Bannana Juice', category: 'drink', price: '15000', description: 'dengan menggunakan buah asli'},
            {id:'4', order:0, promo: 0, image: 'https://picsum.photos/id/326/200',name:' Melon Juice', category: 'drink', price: '15000', description: 'dengan menggunakan buah asli tapi palsuuuu sdfsa sdfsa dfsaf sf sa f fs'},
            {id:'5', order:0, promo: 20, image: 'https://picsum.photos/id/316/200',name:' Kiwi Juice', category: 'drink', price: '15000', description: 'dengan menggunakan buah asli'},
            
            {id:'6', order:0, promo: 50, image: 'https://picsum.photos/id/326/200',name:' Nasi Goreng', category: 'food', price: '25000', description: 'diolah dengan bahan pilihan.'},
            {id:'7', order:0, promo: 0, image: 'https://picsum.photos/id/322/200',name:' Bakso', category: 'food', price: '25000', description: 'diolah dengan bahan pilihan.'},
            {id:'8', order:0, promo: 0, image: 'https://picsum.photos/id/320/200',name:' Nasi Padang', category: 'food', price: '25000', description: 'diolah dengan bahan pilihan.'},
            {id:'9', order:0, promo: 25, image: 'https://picsum.photos/id/326/200',name:' Sate', category: 'food', price: '25000', description: 'diolah dengan bahan pilihan.'},
            {id:'10',order:0, promo: 0, image: 'https://picsum.photos/id/326/200', name:' Bubur Ayam', category: 'food', price: '25000', description: 'diolah dengan bahan pilihan.'},
        ],
        orderPicked : [],
        modalNote : false
    }
            ...
            <Grid container spacing={2}>
                {
                    this.state.listData.map((res, i)=>{
                        const {name, description, price, image, id, order, promo} = res
                        return(
